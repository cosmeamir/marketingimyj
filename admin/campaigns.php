    ...
    <div class="col-md-10">
        ...
        <div class="card mb-3"><div class="card-body">
            <form class="row g-2" method="post" action="/actions/save_campaign.php">
                ...
                <div class="col-md-2"><input name="canal" class="form-control" placeholder="Canal" required></div>
                ...
                <div class="col-md-2"><button class="btn btn-primary w-100">Criar campanha</button></div>
            </form>
        </div></div>
            ...
            <table class="table table-striped">
                ...
                <?php foreach ($campaigns as $c): ?>
                    <tr>
                        ...
                        <td>R$ <?= number_format((float) $c['budget'], 2, ',', '.') ?></td>
                        <td>R$ <?= number_format((float) $c['spent'], 2, ',', '.') ?></td>
